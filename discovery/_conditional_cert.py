...
min_L_09  = 0.392598   # min|L_ces(0.9+it, N=10^7)| over t in [0,200] (t=110.025)
min_L_095 = 0.487849   # min|L_ces(0.95+it, N=10^6)|
max_S_1M  = 142.8421   # max|S(X)| for X <= 10^7
C_GL3_emp = 0.003682   # empirical max|S(X)|/X^{2/3} at X=7642126 (peak, N=10^7)
N = 10_000_000
